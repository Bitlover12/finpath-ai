  ...
  return <Shell>
    <div className="mx-auto max-w-5xl">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div><p className="fp-label">3 · 내 경로</p><h1 className="fp-title mt-2">결론부터 볼게요.</h1></div>
        <div className="flex gap-2"><Link href="/scenario" className="fp-secondary py-2.5 text-sm">조건 바꿔보기</Link></div>
      </div>

      {pending.length > 0 && additional === 0 ? <section className="mt-8 rounded-[28px] bg-[#fff7e6] p-7 sm:p-9">
      ...
      </section> : <section className="mt-8 overflow-hidden rounded-[30px] bg-[#eef6ff] p-7 sm:p-10">
        <p className="text-[13px] font-bold text-[#3182f6]">{r.profile.target_years}년 뒤 예상자산</p>
      ...
      <section className="mt-12">
        <p className="fp-label">이번 달 할 일</p>
        <h2 className="mt-2 text-[26px] font-black tracking-[-0.04em]">복잡하게 말하지 않을게요. 이렇게 시작하면 돼요.</h2>
